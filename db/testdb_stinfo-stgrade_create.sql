...
insert into st_info values (202301, "KimGilDong", "Computer");
insert into st_info values (202301, "HongGilDong", "Game");
select * from st_info;

insert into st_grade  values (202301, 80, 70);
insert into st_grade  values (202301, 90, 75);
insert into st_grade  values (202301, 95, 85);
